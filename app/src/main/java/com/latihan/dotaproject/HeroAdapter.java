...
public class HeroAdapter extends RecyclerView.Adapter<HeroAdapter.ViewHolder> {
    ...
    public HeroAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.hero_holder, null); // Best Practice  LayoutInflater.from(parent.getContext()).inflate(R.layout.hero_holder, parent,false);
