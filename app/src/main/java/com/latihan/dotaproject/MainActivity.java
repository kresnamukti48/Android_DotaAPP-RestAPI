package com.latihan.dotaproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    RecyclerView.Adapter adapter; // Langsung deklarasi class HeroAdapter
    List<HeroModel> heroList = new ArrayList<>();
    private String url = "https://api.opendota.com"; // private final untuk data constant
    ...
    private void getData(String request) {
        ...
        } catch (JSONException e) { //untuk menangkap kesalahan
            e.printStackTrace();
        }
